...
<style scoped>
.txt-orng { color: #ff8000 !important; }
.pulse { animation: pulseanim ease-out infinite .5s; }
@keyframes pulseanim { 0%{transform:scale(1)}50%{transform:scale(1.1)}100%{transform:scale(1)} }
.btn-orng{background:#ff8000;border-color:#ff8000;color:white}
.btn-orng:hover{background:#e67300;color:white}
.login-card{max-width:400px;width:100%;border-radius:1rem;border-top:5px solid #ff8000;background:white}
</style>
